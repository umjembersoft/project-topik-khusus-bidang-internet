...
<div id="wrapper"><!-- #wrapper -->
	...
	<header><!-- header -->
		<h1><a href="#">Edwin Prasetyo</a></h1>
		<h2>Your tag line here</h2>
		<img src="<?php echo Yii::app()->theme->baseUrl ?>/images/FILM.jpg" width="900" height="200" alt=""><!-- header image -->
	...
	<nav><!-- top nav -->
		<div class="menu">
				<?php $this->widget('zii.widgets.CMenu',array(
					'items'=>array(
					array('label'=>'Home', 'url'=>array('/edwin/index')),
						array('label'=>'About', 'url'=>array('/edwin/page', 'view'=>'about')),
				array('label'=>'Contact', 'url'=>array('/edwin/contact')),
				array('label'=>'Login', 'url'=>array('/edwin/login'), 'visible'=>Yii::app()->user->isGuest),
				array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/edwin/logout'), 'visible'=>!Yii::app()->user->isGuest)
				        	),
				)); ?>
		</div>
	</nav><!-- end of top nav -->
